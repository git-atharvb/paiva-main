...
type WorkspaceView = 'home' | 'chat' | 'todos' | 'notes' | 'emails';
    ...
    <aside className="w-full h-full flex flex-col p-5 text-foreground bg-transparent">
      ...
      <nav className="space-y-1 mb-6">
        {[
          ...
          { id: 'emails' as const, label: 'Inbox', icon: () => <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> },
        ].map((item) => {
